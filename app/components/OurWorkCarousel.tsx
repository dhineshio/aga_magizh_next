      ...
      <div className="overflow-hidden" ref={emblaRef}>
        <div className="flex gap-6">
          {workCards.map((card) => (
            ...
            >
              <div className="h-[470px] border-2 border-[#f7f3ef] flex flex-col relative rounded-2xl overflow-hidden group transition-all duration-300 bg-white select-none">
